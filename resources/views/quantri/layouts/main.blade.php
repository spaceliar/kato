...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <!-- Title -->
        <title>Quản lý liên hệ - Katosangyo Việt Nam</title>
    ...
    <link rel="stylesheet" href="public/css/vertical.news.slider.css?v=1.0" />

    <body>
        @include('quantri.layouts.header')
       @yield('content')
        @include('quantri.layouts.footer')
        <!-- JS -->
        ...
        <script src="public/js/jquery-1.8.1.min.js"></script>
       <!--  <script src="public/js/vertical.news.slider.js"></script> -->
    </body>
</html>